...
class Service(models.Model):
    ...
    city = models.CharField(default="istanbul", max_length=255, blank=True, null=True)
    location = PlainLocationField( based_fields=['city'],default='41.0255493,28.9742571', zoom=7, blank=True, null=True)
...
class Event(models.Model):
    ...
    city = models.CharField(default="istanbul", max_length=255)
    eventlocation = PlainLocationField(based_fields=['city'],default='41.0255493,28.9742571', zoom=7, blank=False, null=False)
